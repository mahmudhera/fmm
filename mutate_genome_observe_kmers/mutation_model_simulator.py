...
class mutation_model:
    ...
    def __init__(self, seed, orig_string, p_s, p_d, d):
        self.seed = seed
        self.orig_string = orig_string
        self.orig_length = len(orig_string)
        self.p_s = p_s
        self.p_d = p_d
        self.d = d
        np.random.seed(seed)

    # add getter and setter for p_s, p_d, d, and seed
    def set_p_s(self, p_s):
        self.p_s = p_s

    def set_p_d(self, p_d):
        self.p_d = p_d
